...
**AnswerService** — это бэкенд-приложение, реализующее хранение вопросов и ответов с использованием REST API. Проект написан на языке Go и использует PostgreSQL для хранения данных, а также Docker для контейнеризации.
